...
#         self.set_DPN()
#
#     def set_pse_inv(self):
#         for i in range(self.layer_num):
#             delta_e = self.fc[i].weight.grad.data
#             delta_d = self.dec_fc[i].weight.grad.data
#             mat_e = self.fc[i].weight.data
#             # mat_d = self.dec_fc[i].weight.data
#             self.fc[i].weight.data.grad = delta_e - torch.mm(torch.mm(mat_e, delta_d), mat_e)
#             # self.dec_fc[i].weight.data.grad = delta_d - torch.mm(torch.mm(mat_d, delta_e), mat_d)
#
#     def set_DPN(self):
#         for i in range(self.layer_num):
